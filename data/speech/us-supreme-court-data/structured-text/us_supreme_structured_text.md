...
- creating the false numbers or otherwise its within the
...
- their own securities markets right Thats all {@Quantity} question Professor {@Person} {@Organization} in Bersch and {@Organization} in {@Organization}
...
- possibly in {@Location} If there was in {@Location} thats for the {@Location}ns
...
- {@Organization}
- {@Person} Yes
- {@PersonType} Because what {@Location} is actually saying is what we dont like about  about the
...
- And the {@Location} for the Eleventh {@Location} in a
...
- {@PersonType} {@Person} There are  there are a lot of moving parts in that {@Skill}
...
- its {@Organization} or otherwise are deemed to be {@Skill}able income
- to the {@PersonType}
...
- {@Person} Yes
- {@PersonType}  all his {@Location} accounts are attached
...
- {@PersonType} In other words  in other words no {@Quantity} can attach No {@Quantity} can  no {@Quantity} get the {@Organization} fee by attaching the {@Location} account of the {@PersonType} {@Organization}
- {@Person} Yes
- {@PersonType} Okay
- {@Organization}
...
- to execute an {@Skill}
- Its simply not the way the {@Skill} program was designed and its not reflected in
- the regulation
...
- {@Skill} {@Skill}
- But its the langu{@Quantity} of Title VII itself and in particular h which forbids action
- upon the results
- {@PersonType} Why would {@Organization} have wanted to allow a question like this to be left open for
...
- but heres the way I think we look at it  and the
- {@Location} {@Location} is the nations largest {@PersonType} and we
...
- {@PersonType} rule of the {@Location} were adopted then an
...
- years through
- Afterwards  came the City in the Citys own {@Product}  this is the {@Location}
...
- That was a new decision and indeed thats a decision I think many {@PersonType} would
- logically make after  years because then they
- dont have to worry about the possibility of a disparate
- {@Skill} {@Skill}{@Product}
...
- a rule like the {@Location}s is really antithetical
...
- {@PersonType} Well actually in  in this {@Location} am I correct that  that  years has g{@Quantity} by
- but thats because of the {@Skill} The {@Product} was filed what  months after the -day period ran {@Organization}
...
- was  who had scored
- {@PersonType} Justice {@Person} you had asked about the remedy in the {@Location} and heres how we understand the way
- remedies work in disparate {@Skill} {@Skill} Its largely injunctive in nature
- Its mostly about preventing future problems
- There is a back pay claim that is available that is statutorily capped at  years
- Not every{@Quantity} this -person {@Event} could get that full amount of
- back pay obviously
- Instead what happened here there was a remedial phase at {@Event} and what they did was they
- decided that  the {@PersonType} on both sides admitted that
- people approximately would have been hired out of
- that {@Event} and that provided the appropriate amount of
- back pay
- {@PersonType} {@Person} So you get {@PersonType} Was it  was it  named people or was it just  undifferentiated {@Organization}
...
- {@PersonType} {@Person} So everybody gets  over  times whatever the number of people who
- would have been hired {@Organization}
- {@Location} Right
- And
- {@PersonType} {@PersonType} {@Person} I mean the pay for the number of people
- {@Organization}
- {@Location} Right
- And Mr
- {@PersonType} to respond to your concern before that amount of m{@Quantity}y
- is not  you couldnt go back and look to earlier
- periods of time outside of the statute of limitations
- outside of the -day period rather only any
- subsequent use
- For {@Event}ple in this {@Location} the remedy couldnt look to the {@Quantity} round of {@Skill} because no
...
- And thats I think a further limit on the way in which this
...
- {@Event} because disparate {@Skill} {@Skill} doesnt
...
- {@PersonType} And that would be clear even though it had not been established much earlier
...
- {@Organization}
- {@Location} Thats exactly correct Justice {@Person}
- {@PersonType} What  of what use is a statute of limitations that  that  that operates
...
- {@PersonType} {@Person} So I suppose the benefit is not that the City k{@DateTime}s its safe  it can
...
- until every{@Quantity} that {@Location} had been called for
- {@Skill}
- The City also publicly admitted that this tiered eligibility list had adverse {@Skill} on
- {@PersonType} and {@PersonType}s were aware of this
...
- Calling other {@PersonType} from a {@Skill} {@Location} from which
...
- is that kind of a list its the same as this {@Location}
...
- But thats because {@PersonType} {@Person} Well what is  what is the list other than an administratively convenient way
...
- then its as though it were {@Skill}ful
- Thats your position
- {@Organization}
- {@Person} The statute a requires an un{@Skill}ful {@PersonType} {@Person} Is that  is that theres a free pass
- You dont sue within  days of the {@Skill} of the list and the notice of the list you sue
- days later
- The discriminatory {@Event} gets frozen the status quo gets frozen forever
- Thats  that is your position is it not {@Organization}
- {@Person} That is the function of the operation of the statute of limitations and of course
- its not unique to Title VII
- {@PersonType} {@Person} But this is not exactly a title  a statute of limitations
- Its a time you have to file your charge
- Its a charge {@Skill}
- {@Organization}
- {@Person} Correct
- And {@PersonType} {@Person} Theres also a -year statute of limitations in Title VII
- You cant get back pay I think for more than  years
- {@Organization}
...
- {@DateTime} the defining feature {@PersonType} {@Person} You  you dont have {@Quantity} {@Location} I think certainly not from this {@Location} of
- disparate {@Skill}
...
- period
- {@DateTime} that is a perfectly good rule no matter whether its discriminatory treatment or discriminatory
- {@Skill}
...
- {@Skill} period
- {@PersonType} How is it absent Because
- {@PersonType} the statute says that the established  the  its
- established  namely the un{@Skill}ful {@Skill} {@Event}
- its established only if and certainly if the
- {@PersonType} uses {@Organization}
- {@Person} Right
- {@PersonType}  a particular {@Skill} {@Event} that has a disparate {@Skill}
...
- established
- And whats so interesting is that the reliance on those words uses an {@Skill} {@Event}
- its a few words plucked out of the middle of section k
- You actually cant apply section k literally to this {@Location} and have anything that approaches
- anything that makes sense
- And thats because section k actually goes on after those words that get highlighted over and over and its  and it refers to
- {@PersonType} the rest of what happens in a {@Location} when a claim of disparate {@Skill} is tried
- And so if you {@PersonType} {@PersonType} So why dont we look at subsection h {@Organization}
- {@Person} Subsection {@PersonType} {@PersonType}  that says  and its an  it shall be an un{@Skill}ful {@Skill} {@Event} for
- an {@PersonType} to give and  conjunctive  and act
- upon the results
- {@Organization}
- {@Person} Correct
- {@PersonType} {@PersonType} So when you hire arent you acting upon the results And how are you acting upon  you {@DateTime} be acting upon it as {@PersonType} argues
- when you {@Event}ify but why arent you acting upon when
- you hire {@Organization}
- {@Person} Because there is no act that limits and {@Event}ifies
- And whats interesting about section h its not {@PersonType} {@PersonType} I  I go back to Justice {@Person}s point
- Isnt it in the very act of {@Skill} you are using the {@Skill} results and saying
- each time you do it youre saying {@Organization} going to cut off at this limit and {@Organization} not going to consider some{@Quantity}
- outside of this limited tier
- {@PersonType} {@Organization}
- {@Person} Well thats what is actually missing in this {@Location}
...
- {@PersonType} {@PersonType} But isnt that what {@Event} and {@Skill} means Meaning that each time as you continue {@PersonType} you are using a particular
...
- {@Event}ify
- {@DateTime} to complete my answer to Justice {@Person} {@PersonType} May I ask this question Ms
- {@Product} Would your argument be the same if the {@Event} in this {@Location} were  required a {@Location}
- diploma
- {@PersonType} Did you understand my question {@Organization}
- {@Person} {@Organization} sorry
- I didnt realize you had finished
- Excuse me
- {@PersonType} Suppose the {@Event} were a {@Location} diploma
- Could that  would you make the same argument as youre making {@DateTime} {@PersonType} {@Person} And lets add to that that it was adopted  years ago {@PersonType} Thats right
...
- opportunities
- And it could be when they enter {@Location} but that is not an appropriate time so if its
...
- closed universe
- Everybody affected by the Citys eligibility list and the {@Skill} and the cutoff score knew
- from the moment {@PersonType} No but  but in my {@Event}ple everybody who is not a {@Location} graduate
...
- the same thing {@PersonType}s {@PersonType} {@Person} You force people to challenge the {@Event} when they dont even k{@DateTime} if its
- going to affect them
- In the hypothetical that has been discussed somebody who didnt graduate from high
- {@Location} you k{@DateTime} wants to be something other than a
- {@PersonType}
- But that doesnt work out and then he says well {@DateTime} I want to be a {@PersonType}
- And they say well you cant because you didnt graduate from high
- {@PersonType} {@Location}
- {@Organization}
- {@Person} Right
- {@PersonType} {@Person} And I think your position is that well he should have filed that
- {@Product} earlier no {@Organization}
- {@Person} Our position is that the {@Skill} period runs from the un{@Skill}ful {@Event}
- And the {@Location} has stressed it is important to confirm {@PersonType} {@Person} Well but what is the un{@Skill}ful {@Event} {@Organization}
...
- this job or not had to sue and its only those people
...
- time I hire {@Organization} not going to use a {@Location}  {@Organization}
- not going to look at people who dont have a {@Location}
- diploma and {@Organization} not going to look at people who dont
- have a {@Skill} score above
- Whats the difference between those {@Organization}
...
- We didnt go back to look at the {@Skill}
- We didnt consider {@PersonType}s
- We didnt reject them each time
- {@PersonType} There could be {@PersonType} Well somebody getting some{@Quantity} getting a letter that you sent to people who
- were {@PersonType} didnt k{@DateTime} that
...
- You didnt tell them anything about  you didnt tell them that you were
- going to fill all of your available positions with
- people who were {@Event}ified as well {@PersonType} in that
- letter {@Organization}
- {@Person} With respect {@PersonType}  did you {@Organization}
...
- Thats more than any other {@Event} {@PersonType} {@Person} Just to follow up on Justice {@Person}s question what if it were different
- What if the letter said look you didnt get youre
...
- And the {@Location} has made quite clear that you dont  a complainant or
- {@PersonType} does not have to feel all of the consequences
- right at the outset to {@PersonType} {@Person} Well thats kind of a bad {@Skill} isnt it Youre telling people who {@DateTime} probably not be injured at all  you are saying well
- you still have to go into {@Location} and sue
- {@Organization}
- {@Person} With respect {@PersonType} {@Person} they are injured
- Their {@Skill} will be delayed possibly substantially
- {@PersonType} {@Person} Oh sure
- No I
- {@PersonType} understand that but you k{@DateTime} lets say we
...
- If the {@PersonType} Well why did the City say that it was planning to give a new {@Skill} in
...
- challenge this
- {@Organization}
- {@Person} But it wouldnt change the fact that there had been at least a  if you wait for
- the next list you still have been delayed at least
- {@PersonType} years in your ability to be hired as a {@PersonType}
- And as far as the reason why we didnt follow through on the
...
- But {@PersonType} But you dont challenge that
- {@Organization}
- {@Person}  surely the {@Location} {@PersonType} You dont challenge that
- You {@DateTime} ack{@DateTime}ledge that the Plaintiffs were treated
- un{@Skill}fully
- {@Organization}
- {@Person} We have not pressed that claim
- That is correct Justice {@Person} but {@PersonType} And were you prejudiced by the delay in the {@Skill} of the {@Organization} charge {@Organization}
...
- remember
- But a statute of limitations actually doesnt require prejudice so we didnt undertake to try to
- prove that
- The  repose arises naturally at the end of the {@Skill} period
- Its not something that  that the {@PersonType} has to earn either by capitulating to the
- {@PersonType} demands or otherwise proving prejudice
- And in a {@Location} like this it  it wasnt possible simply to take the list down
- The {@Location} opinion in {@Person} makes that quite clear
- Our {@PersonType} told us all the way through the {@Event}  he {@Skill}ified
- at the {@Event} {@PersonType} {@Person} You didnt have to take the list down
...
- un{@PersonType}
- {@Organization}
- {@Person} I  I believe {@PersonType} {@Person} You didnt have to throw out the list
- {@Organization}
- {@Person} I believe {@PersonType} {@Person} You didnt have to throw out the {@Skill}
- {@Organization}
- {@Person} I believe the {@Location} opinion in {@Person} addresses that as well
- That thats a  a
- {@PersonType} misuse of the {@Skill} scores
- The {@PersonType} was resolute even through the {@Event} {@PersonType} {@Person} I thought the {@PersonType} said  the {@Skill} devisor said he didnt make up that
- {@Quantity} cutoff
...
- {@PersonType} to  to perform in the way {@PersonType} {@Person} But you  youve lost youve lost on that
- {@Organization}
- {@Person} We have
- But the reason that Im mentioning it is because its not simply a matter
- of  of why dont you take the list down
...
- scores its not taking the list down its just saying
...
- There were about  {@PersonType} at  or above and
- there were   or above
- So calling in random order {@PersonType} {@Person} Youve got to  I mean youve just got to take your  get as good
- {@Skill} advice as you can and determine is it  are we
...
- They look  well if I do this {@Organization} going to be in trouble
- if I do this {@Organization} going to  but I have got to decide
- what I should do
- {@Organization}
...
- compared with the {@Location} of {@PersonType} had a disparate
- {@Skill}
- But thats not a new violation
- Thats not a new {@Event}ification and it doesnt limit anybodys
- opportunities in any way beyond what they were already
- limited
- Thats the old violation
- Thats the {@Quantity} they didnt charge
...
- But it actually didnt either
- That also was the old violation
- That shortfall was compiled by comparing the number of
- {@PersonType} who were hired using the  cutoff
- score and the number who would have been called for
- further {@Skill} if {@PersonType} How do you  the problem I have with all of this  it makes entire sense except
...
- {@Organization}
- {@Person} Correct
- But you have {@PersonType} Which is what happened here
- {@Organization}
- {@Person} But the fact {@PersonType} They used {@Organization}
- {@Person} Excuse me Justice {@Person}
- The statute goes on and it describes the later things
- that happened at {@Event}
- So in our view read literally {@PersonType} Where  where does it go
...
- thats what the person k{@DateTime}s at the outset
- Section k talks about the burden of proof and how you go about proving these at {@Event} and thats
- why it uses the word established
- But thats also why it describes the entirety of what happens at {@Event}
...
- the absurd result that the {@Skill} period doesnt run
...
- {@PersonType} after the {@Location} {@Location} decision which is something
- like  years after the {@Event} in this {@Location}
- And thats because that was the moment at which it was
- established
- And thats why we think that k does not bear on this
- And h {@PersonType} Is my impression  is there anything else in that k You see it lists about  things lets say   imagine
...
- {@Organization}
- {@Person} Right and thats why {@PersonType} And  and so I thought looking at the list its quite right that its used for
- a different purpose but {@Organization}
- {@Person} Its not {@PersonType} But I mean this k has to do with a different thing but  but  and the
...
- we dont think that it should be
- It doesnt bear on accrual
- But even if k is consulted it doesnt
- {@PersonType} it doesnt say that any use of an {@Skill} {@Event} is
- is a new un{@Skill}ful act
- It has to be an {@Skill} {@Event} that actually has disparate {@Skill}
- {@PersonType} Well youd have to then say that all the things that are there the other {@Quantity}
- and so forth  all those {@Quantity} things {@Organization}
- {@Person} This is actually {@PersonType} Well {@Organization}
- {@Person} Excuse me Justice {@Person}
...
- for that reason {@PersonType} Yes
- {@Organization}
- {@Person}  you really cant pluck a few words out of the middle
- {@PersonType} No well thats true it does {@Organization}
...
- somebody else whether the person doesnt hire somebody
...
- {@DateTime} there is not even an argument in the other sides {@Product} neither of them that explains why
...
- there are a number of {@Skill} reasons that while we dont
...
- Everything else that happened after that either didnt affect the {@PersonType}s at all as in
...
- statute
- Its much like the proposition of good faith
...
- {@PersonType} But in a sense that cuts against you
...
- {@Skill}ed So its not as if {@Organization} did nothing or its not as if the amendment accomplishes nothing even
...
- end of quote has  theres never has been {@Quantity} the
- {@Skill}
...
- {@Location}ruptcy {@PersonType} lets move the period lets use this
- provision and we will get another period that doesnt
...
- {@PersonType} What  where can you move it I dont really  this is the same line of inquiry as Justice {@Person}
- Whats the  what has to be the
...
- {@PersonType} {@Person} The review of the determination or the request to move the period is  is
...
- {@PersonType} {@Person} So your objection to the fact that the {@PersonType} has more discretion with respect
- to defining {@Skill}ed disposable  you dont mind the
- discretion on the other side
- {@Organization}
- {@Location} No Your {@Skill} I dont believe the discretion is not in {@Skill} the income
- only in {@Skill} the time period
- {@PersonType} {@Person} Right but the only purpose of moving the time period is to change the
- income
- {@Organization}
- {@Location} Thats true
...
- {@PersonType} There is another discretion that you dont seem to object to
- {@Quantity} way the {@PersonType} can get out of the bind that hes put
...
- {@PersonType} What constrains the {@PersonType} in allowing or not allowing the revision Doesnt he have the same kind of discretion with regard to the
- revision that youre objecting to with regard to his
- establishing the {@Skill}s {@Organization}
- {@Location} Justice {@Person} I dont think so
...
- So the {@PersonType} would be able to say my wifes income is {@DateTime} g{@Quantity} so we want to take that out
- of the formula
- {@PersonType} But thats the same thing thats being argued here that  that you start with
...
- I dont see that theres any difference
- {@Organization}
- {@Location} There {@DateTime} not be except that there is a statutory requirement as to how that is
- accomplished and thats where the Aii comes
- into play
- Its not so much that there is a problem {@PersonType} What your {@Location} comes down to is the {@Location} can do this but it has to do
...
- {@PersonType} Maybe {@Organization}
- {@Location} It {@DateTime} be yes
- It depends on the facts of the {@Location}
- {@PersonType} {@Person} Well thats a good answer isnt it because your point would be the
...
- {@PersonType} That was a {@PersonType}ly question
- {@Organization}
- {@Location} {@Organization} sorry {@Organization} sorry I didnt hear
- {@PersonType} {@Person} No my  my point and what I thought your point would be is that the fact
...
- other area {@Skill}ed disposable income its not
- {@Organization}
- {@Location} I agree
- Laughter
- {@PersonType} But can the  can the plan be modified based on  can the plan be modified based
...
- The most {@PersonType} Well if it cant then how is this modification remedy going to work {@Organization}
...
- The {@PersonType} {@DateTime} say Well I {@DateTime} be losing that but I dont k{@DateTime} what my actual
- circumstances are going to be  years from {@DateTime}
- Chapter  is a fluid process
- {@PersonType} Your argument is that the {@Location} has to confirm a plan that is really not
- confirmable because the {@PersonType} cant possibly make the
...
- {@PersonType} explain it then {@Organization}
...
- But what {@Organization} saying is that the statute needs to be
...
- {@PersonType} {@Person} Well what in addition to  you brought up the  solution that she doesnt do
- what the statute tells her to do so shes able to move
...
- Aii is {@Quantity} of those options
...
- There is no {@Skill} there is no repossession theres no
- garnishment theres no {@Skill}{@Product}
...
- been {@Organization}
- {@Location} Thats very possible but its a formula that {@Organization} thought to place into
...
- its not okay for her to use chapter  with a plan that
...
- did it she cant
- Its kind of like driving a {@Product}
- You cant expect that a the {@Product} is going to perform well if
- you dont turn the {@Product} on
- {@PersonType} {@Organization}
- {@Location} And here she didnt turn the {@Product} on
- {@PersonType} Can I come back to Justice {@Person}s question about whether there would
- ever be the opportunity to adjust the confirmed plan
- Because as you say the plan here would not have been
- confirmed but that  that isnt the {@Location} always
...
- {@Organization}
- {@Location} Maybe not  {@Organization} sorry
- {@PersonType} In other words is your response to Justice {@Person} always that it will
...
- because thats part of the {@Skill} order
...
- {@PersonType} {@Person} Isnt that  wouldnt that amount to just a  a waste of everybodys time to
- dismiss it and then refile it and then she gets a time
- period that doesnt  why  why not just drop out
- those  months that are not representative of her
- income {@Organization}
- {@Location} Because Justice {@Person} the statute does not permit that
- Its not within the formula and thats the question Is the formula {@Skill} or is it not {@Skill} If it is {@Skill} then this  obviously
...
- the {@Location}
- {@PersonType} {@Person} Where is that by the way the provision that allows it to move the
- -month period {@Organization}
- {@Location} Its in A and it provides that the term current {@DateTime} income means
...
- little i  or ii
- And those are  thats the disjuncture its the -month period prior or some other
- time {@Skill} and the langu{@Quantity} is important
- {@PersonType} What do you say about {@Location}s
- in which moving the -month period cant solve the
...
- schedule of current income If theres been a plan confirmed or a plan proposed then the income schedule
- had to have been filed
- {@Organization}
- {@Location} {@PersonType} {@PersonType} You dont do {@Quantity} without the other
- {@Organization}
...
- {@Organization} going to the situation where the plan has been proposed
- lets say
- The {@Location}  if a schedule of income has been filed then its without any jurisdiction to change
- the -month lookback period correct
- {@Organization}
- {@Location} I dont agree with the word jurisdiction Justice {@Person}
- {@PersonType} {@PersonType} Well it cant under A
- {@Organization}
...
- {@PersonType} Can I ask  yes there is {@Quantity} more question
- {@Organization}
- {@Location} Okay
- {@PersonType} Can I ask whether  which you have {@DateTime} invoked does not provide the same
...
- Its obvious that {@Organization} intended the formula
- It would not make much sense to read the statute to have
- some other formula
- {@PersonType} Well then  then  okay
- You are between a rock and a hard place
- Either  gets you out of that formula which is what youve said
- its {@Quantity} way out or it isnt
- Which is it {@Organization}
- {@Location} I havent said that it gets me out of the formula
- It gets me out of the time {@Skill} issue because certainly the statute doesnt take into
...
- {@PersonType}  subsequent to the {@Skill}
- {@Organization}
...
- objects then as of the effective date of the plan its
...
- Its not just {@Skill}ed disposable income but its {@Skill}ed
...
- Current {@DateTime} income is in  its at p{@Quantity}
- Thats where we get the -month period
- And it tells us that current {@DateTime} income is the aver{@Quantity}
- {@DateTime} income from all sources so its very
- encompassing without regard to whether such income is
- {@Skill}able income derived during the -month period
- So my {@PersonType} argument is that well {@Organization} said  months
...
- problem there
- Before {@Organization} {@Location} didnt k{@DateTime} what the  didnt agree on what the baseline was for
- {@Skill} some{@Quantity}s income
- Some {@Location} would say all right you are a Chapter  {@PersonType} right away {@Organization} going to look at the
- la{@Skill} month
...
- But the {@Quantity} point is that this term current {@DateTime} income isnt principally a Chapter
- term at all
- So my {@PersonType} argument is that {@Organization} stuck this -month period into Chapter  so it would
...
- So its not like {@Organization} in Chapter  fixed the -month period
- which would give  have a sort of a gravitational pull
- You wouldnt want to throw that out too lightly
...
- But its not like {@Organization} added to Chapter  this -month
- concept
- It added it to Chapter  where its in full force and effect
- {@PersonType} You  you  you have lost me
- {@Organization}
- {@Person} Okay
- {@PersonType} {@Organization}
- {@Person} Sure
...
- {@PersonType} No I got  I got it there
- {@Organization}
- {@Person} Okay
- Sure
- {@Organization} sorry
...
- income  thats the  months current {@DateTime} income
- Thats the -month period of income
- {@PersonType} I  I  I see
- I see
- {@Organization}
- {@Person} See thats mostly where it matters
- Then {@Organization} borrowed it in Chapter
- But it didnt get rid of as was pointed out before the
- term  {@Skill}ed it didnt get rid of the period
...
- Thats what my {@PersonType} says the phrase {@Skill}ed disposable income to
...
- because thats {@Skill}
- {@PersonType} Without the word {@Skill}ed {@Organization}
- {@Person} {@Organization} sorry {@PersonType} Without the word {@Skill}ed {@Organization}
- {@Person} Thats exactly
...
- {@PersonType} {@Person} Why dont you follow his suggestion and just move the -month period because
- the statute specifically grants that authority to the
- {@PersonType} {@Organization}
- {@Person} Sure
- Let me make a few points about that sir
- So {@Organization} again read the langu{@Quantity}
- again
- So we are on
- It says that  little ii is going to be  its going to be  months ending on the
...
- their expenses go down  lets say you had a {@Product} but
...
- In a statute thats designed to make sure the {@PersonType} pays a
- much as possible to her {@PersonType}s its very strange to
- put this entirely in the {@PersonType}s hands
- {@PersonType} Can I ask you this
...
- They dont k{@DateTime} that they are going to get it or they
- expect to get a {@Skill}
- And {@Location} will say even if thats pretty likely until you have actually got it we
- are not going to count it for purposes of b come
- back under
- And we point out in our merits brief that in fact its not quite on point but she got a settlement
...
- {@Location}
- When its k{@DateTime}n or virtually certain we think that is sufficient  akin to Justice {@Person}s
...
- not to exceed  days
- So it does seem to constrain the power of the {@Location} to shift this period all
- around
- So I have made {@Quantity} points
- {@Quantity} is its a {@Quantity}-way ratchet for the {@PersonType} {@Quantity} its not
- unlimited
- The {@Quantity} is it just doesnt make any sense
...
- believes that she shouldnt have to make the {@Skill}s
- that would be required under the {@PersonType}s reading of
- {@Skill}ed disposable income
- The question is how we get there
- The {@PersonType}s answer is that you are required by the text {@Organization} sorry {@Organization} took this
- option away
...
- {@PersonType} {@Person} Well I think  I think thats exactly right when you look at term
- {@Skill}ed disposable income
- {@Organization}
- {@Person} Yes
- {@PersonType} {@Person} But if you look as {@Organization}
- {@Person} Yes
- {@PersonType} {@Person}  as a defined term
- different  different argument different kettle of
- {@Product}
- I mean because particularly in a statute intended to restrict discretion its a way to do it
- You look at it in the abstract {@Skill}ed disposable
- income it doesnt achieve that objective
- {@Organization}
...
- And so its kind of odd to say that the answer to our
- position is to turn to all of these other discretionary
- {@PersonType} {@Person} What if you  you wanted to achieve your {@PersonType} result and you had a
- definition of disposable income and you wanted the
- {@Location} to  you dont want to say {@Skill} that {@PersonType}
...
- {@PersonType} {@Person} No thats altering disposable income  the definition of disposable
- income
- {@Organization} asking isnt the most natural word to achieve your {@PersonType} result to use {@Skill}ed
...
- agrees on the definition so really its not an unusual
- term
...
- income
- Another piece of {@Skill} is we k{@DateTime} that shes not going to have the same income in the future
- If there are no further questions
- {@PersonType} {@Person} Thank you Counsel
- Ms
- {@Product}
- ORAL ARGUMENT OF {@Person} ON BEHALF OF THE UNITED STATES AS AMICUS CURIAE SUPPORTING {@PersonType} {@Organization}
- {@Person} Mr
...
- simpli{@Location} over accuracy by telling {@Location}s to
...
- {@PersonType} But do you think {@Location}s are supposed to be {@Skill} forecasters For {@Event}ple if you  after calculating the {@PersonType}s income
- during the -month period the -month lookback period
- should the {@Location} said well  say Well its  {@Skill} is {@Skill}ed to be such-and-such over
...
- {@DateTime} or ten years theres been a  {@Quantity}
- increase in salary per year so {@Organization} going to multiply it
- by  multiply the disposable income figure like that {@Organization}
- {@Person} Certainly not Justice {@Person}
- {@PersonType} Well why not You say that the {@Location}s should take into account things
- that are likely to occur in the future
- {@Organization}
- {@Person} we are not saying that {@Location}s should ever
- speculate about what might happen in the future
- What we are saying is that {@Location}s should take into
...
- {@PersonType} Well k{@DateTime} will happen is quite different from likely to happen and I thought
- your {@Skill} was likely to happen
- {@Organization}
- {@Person} Well likely to happen based on what you k{@DateTime} {@DateTime}
- I think  we havent suggested a particular burden of proof
- {@PersonType} Not  not likely based on what you k{@DateTime}
- Well thats quite different from you k{@DateTime} it will happen
- {@Organization}
- {@Person} Right
...
- that cant be extended time-wise
...
- {@PersonType} Is there a difference between your {@Skill} and the {@PersonType}s {@Skill}
- {@Organization}
...
- And so thats the type of  so it will no longer be an expense going {@PersonType}
- Under {@PersonType}s view a {@Location} would not be able to
- {@PersonType} Thats  thats k{@DateTime} will happen
- That is k{@DateTime} will happen
- But I dont k{@DateTime} how you can at {@Quantity} and the same time say {@Location} shall not speculate and then say that the {@Skill} is
- likely to happen
- {@Organization}
- {@Person} {@PersonType} I mean to  you k{@DateTime} to look {@PersonType} and say Is it likely or not likely Thats {@Skill}
- I dont k{@DateTime} a better definition of {@Skill} to tell you the truth
- {@Organization}
- {@Person} Okay
- But then we wouldnt  we are not trying to advance that view of
- likely
...
- going {@PersonType}
- {@PersonType} {@Person} It seems to me that
- well depending on how broad a theory you are adopting
- of whats {@Skill}ed and whats not that you are taking
...
- {@Organization}
- {@Person} {@PersonType} {@Person} Whats going to happen Whats the situation going to be What should you k{@DateTime} the {@PersonType}s get What should the {@PersonType} get There is no reason to kind of shoehorn those into the {@Skill}ed disposable income
- {@Organization}
...
- The {@Location} cant confirm it {@PersonType} {@Person} Well is that  I mean lets say your {@PersonType} wins up to the point and
...
- That  it could do it that way couldnt it {@Organization}
- {@Person} {@Organization} sorry if she got a higher-paying job just before Is that what youre suggesting {@PersonType} {@Person} Well whatever the situation is cant that be taken into account when it
- comes to {@Skill} {@Organization}
- {@Person} Well it could affect the  well {@Quantity} thing that is important to note that hasnt
...
- theres an objection by the {@PersonType} or the {@PersonType} and
- b comes into play to prohi{@Quantity} a {@Location} from
- considering the same facts it k{@DateTime}s about what is going
- {@PersonType} What if the {@PersonType} is a waiter and during the last month of the -month period
- because of some change of the {@Skill} the waiters tips
- have g{@Quantity} up either way up or way down Whats the {@Location} supposed to do then {@Organization}
...
- It reduces the chance for {@Skill} because it sort of takes some of the significance
...
- special circumstances exceptions and it didnt on the
- income side {@Organization}
- {@Person} Well the special circumstances exception comes in in the {@Skill} of
- the {@PersonType}s current disposable income but it doesnt
...
- that isnt accounted for in the standard expenses or an
- expense that is accounted for but is higher than is
- accounted for in those expenses
- But again it doesnt tell you what to do  how to {@Skill} that number going
- {@PersonType}
- {@PersonType} {@Person} What about the argument that this is a simple thing she didnt have to file the
- plan  she didnt have to file the {@Skill} at a time
...
- And if I could address Section AAii option that the {@PersonType} offers  I
- mean {@Quantity} thing to note is it doesnt give the {@Location} the
...
- {@PersonType} {@Person} Well the {@PersonType} has the option of objecting the {@Skill} of the
- plan
- {@Organization}
...
- benefit
- {@PersonType} {@Person} They cant say I object because the -month period is unrepresentative
- because of this particular event {@Organization}
- {@Person} They could say that but its not clear in the {@Skill} that that is a basis for
- refusing to confirm a plan
- I think they would have to {@PersonType} {@Person} Does the {@Skill} have a position on that {@Organization}
- {@Person} I think unless there were bad faith its not clear how that can be a basis for not
